...
<section>
    ...
    <ul>
        ...
        <li>Consistency: use similar layout, controls and colors for similar functions
        ...
        <li>Simplicity: avoid unnecessary complexity. Make navigation simple.
        <li>Closure: a task that involves multiple steps should have a clear beginning and end, and the user should be able to navigate between steps
    </ul>
