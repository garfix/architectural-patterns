...
$categories = [
    ...
    ["code" => CAT_PROBLEM_SOLVING, "name" => 'Problem solving',
        ...
        "patterns" => ["Algorithm", "Heuristic", "Search", "Inference Engine", "Planning", "Neural Network", "Generative AI", "Agent", "Multi-Agent System", "Blackboard", "Process Control", "Explainability"]],
...
$patterns = [
    ...
    [
        ...
        "image" => "markov-decision-process.png",
    ...
    [
        ...
        "image" => "markov-chain-monte-carlo.png",
        "link" => "markov-chain-monte-carlo",
    ],
    [
        "name" => "Gaussian Process",
        "image" => "gaussian-process.png",
    ...
    [
        ...
        "image" => "maximum-likelihood-estimation.png",
        "link" => "maximum-likelihood-estimation",
    ],
    [
        "name" => "Regression Analysis",
        "image" => "regression-analysis.png",
    ...
    [
        ...
        "image" => "simulated-annealing.png",
        "link" => "simulated-annealing",
    ],
    [
        "name" => "A* Search Algorithm",
        "image" => "a-star-search.png",
        "link" => "a-star-search",
    ],
    [
        "name" => "Hill Climbing",
        "image" => "hill-climbing.png",
        "link" => "hill-climbing",
    ],
    [
        "name" => "Tabu Search",
        "image" => "tabu-search.png",
        "link" => "tabu-search",
    ],
    [
        "name" => "Dynamic Programming",
        "image" => "dynamic-programming.png",
        "link" => "dynamic-programming",
    ],
    [
        "name" => "Linear Programming",
        "image" => "linear-programming.png",
    ...
    [
        ...
        "image" => "genetic-programming.png",
        "link" => "genetic-programming",
    ],
    [
        "name" => "Particle Swarm Optimization",
        "image" => "particle-swarm-optimization.png",
        "link" => "particle-swarm-optimization",
    ],
    [
        "name" => "Ant Colony Optimization",
        "image" => "ant-colony-optimization.png",
        "link" => "ant-colony-optimization",
    ],
    [
        "name" => "Evolution Strategy",
        "image" => "evolution-strategy.png",
    ...
    [
        ...
        "image" => "k-nearest-neighbors.png",
        "link" => "k-nearest-neighbors",
    ],
    [
        "name" => "Naive Bayes Classifier",
        "image" => "naive-bayes-classifier.png",
        "link" => "naive-bayes-classifier",
    ],
    [
        "name" => "Linear Discriminant Analysis",
        "image" => "linear-discriminant-analysis.png",
        "link" => "linear-discriminant-analysis",
    ],
    [
        "name" => "Convolutional Neural Network",
        "image" => "convolutional-neural-network.png",
        "link" => "convolutional-neural-network",
    ],
    [
        "name" => "Recurrent Neural Network",
        "image" => "recurrent-neural-network.png",
        "link" => "recurrent-neural-network",
    ],
    [
        "name" => "Long Short-Term Memory",
        "image" => "long-short-term-memory.png",
    ...
    [
        ...
        "image" => "generative-adversarial-network.png",
    ...
    [
        ...
        "image" => "principal-component-analysis.png",
    ...
    [
        ...
        "image" => "self-organizing-map.png",
        "link" => "self-organizing-map",
    ],
    [
        "name" => "Association Rule Learning",
        "image" => "association-rule-learning.png",
    ...
    [
        ...
        "image" => "temporal-difference-learning.png",
        "link" => "temporal-difference-learning",
    ],
    [
        "name" => "Policy Gradient Method",
        "image" => "policy-gradient-method.png",
    ...
    [
        "name" => "Expert System",
        "image" => "expert-system.png",
        "link" => "expert-system",
    ],
    [
        "name" => "Constraint Satisfaction Problem",
        "image" => "constraint-satisfaction-problem.png",
