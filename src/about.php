...
<section>
    ...
    <p>
        <b>2025-04-12</b> Renamed "General" to "Code structure", and "Topics" to "Code purpose". Moved "Code conventions" to "Cross-cutting concerns". Moved "Types of code" to "Code structure". Added <a href="gen-ai">Gen AI</a>
    </p>
    <p>
